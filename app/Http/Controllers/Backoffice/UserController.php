...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.backoffice.users.index')->with('success', 'User created successfully.');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('admin.backoffice.users.index')->with('success', 'User updated successfully.');
    }
