...
<div class="w-full px-6 py-6 mx-auto">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-soft-xl rounded-2xl p-6">
            ...
            <div class="mb-6">
                <h6 class="text-xl font-bold text-slate-700">Edit User</h6>
                <p class="text-sm text-slate-400 mt-1">Perbarui data akun pengguna</p>
            </div>
            ...
            <form action="{{ route('admin.backoffice.users.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-semibold text-slate-600">Password Baru</label>
